# RAG Pro Max v3.2.1 操作手册

**版本: v3.2.1**  
**更新日期**: 2025-12-30  
**核心特性**: 现代化配置中心 (Tabs UI)、自定义服务商插件、变量物理隔离、Zero-Click 模型同步
...
### 2.1 模型服务中心 (v3.2.1 升级)
- **Tabs 导航**: 厂商选择移至顶部，横向空间全量释放。
- **➕ 新增自定义**: 支持注册非内置的 AI 厂商。只需输入名称、Base URL 和 API Key 即可。
- **自动感应**: 输入有效地址后，系统后台自动加载模型列表，无需手动刷新。
- **变量隔离**: 每个厂商的配置独立保存，互不干扰。
