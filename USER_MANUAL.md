...
1. [快速开始](#4-快速开始)
2. [v2.4.4 UI交互优化版](#2-v244-ui交互优化版)
3. [v2.4.3 重构优化版](#2-v243-重构优化版)
4. [v2.0 新功能](#3-v20-新功能)
5. [基础配置](#5-基础配置)
6. [知识库管理](#6-知识库管理)
7. [文档上传](#7-文档上传)
8. [智能问答](#8-智能问答)
...
**Web抓取**:
- **智能分析**: 新增URL输入框右侧智能分析按钮，一键分析网站结构
- **布局优化**: 更加紧凑的输入布局，提升屏幕利用率

**知识库详情**:
- **统计卡片**: 采用2x2网格布局显示文件数、大小、片段数和模型信息
- **显示修复**: 修复了在文件缺失情况下显示"空知识库"的问题

**知识库管理**:
- **管理界面**: 优化知识库名称输入框布局
- **响应式**: 改进侧边栏在不同屏幕尺寸下的显示效果
