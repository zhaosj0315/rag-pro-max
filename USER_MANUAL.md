# RAG Pro Max v2.9.0 操作手册

**版本: v2.9.0**  
**更新日期**: 2025-12-29  
**核心特性**: 智能研究(Deep Research)、追问面板UI升级、极简9列工具栏、联网实时增强
...
1. [快速入门](#1-快速入门)
2. [一体化功能工具栏 (v2.9.x)](#2-一体化功能工具栏)
3. [智能研究与追问面板](#3-智能研究与追问面板)
4. [终极文件详情档案](#4-终极文件详情档案)
5. [智能溯源系统](#5-智能溯源系统)
6. [macOS深度集成](#6-macos-深度集成)
7. [核心功能详解](#7-核心功能详解)
8. [常见问题](#8-常见问题)
...
### 2.2 智能功能开关 (v2.9.0 新增)
- **🧠 深度思考 (Deep Think)**: 在检索前对问题进行语义分析与改写建议。
- **🌐 联网搜索 (Web Search)**: 抓取互联网实时信息，自动进行质量评分（🏆/⭐/⚠️）。
- **🔬 智能研究 (Deep Research)**: 
    - **多维度分析**: 模拟专家思维，对复杂问题进行拆解研究。
    - **事实核查**: 在生成答案前执行额外的逻辑验证步骤。
    - **综合报告**: 针对科学、技术或法律等专业问题提供更严谨的论述。
