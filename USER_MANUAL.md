# RAG Pro Max v2.8.1 操作手册

**版本: v2.8.1**  
**更新日期**: 2025-12-29  
**核心特性**: 联网实时增强(折叠版)、极简UI优化、智能查询优化、真实二级模型联动
...
- **🌐 联网搜索 (Web Search)**: 
    ...
    - **智能质量评估 (v2.8.1)**: 自动对搜索结果进行权威性、完整性和专业性评分，并标注质量标签（🏆/⭐/⚠️）。
    - **折叠展示与排序**: 搜索到的网页详情会按质量评分自动排序，并折叠在状态栏中，保持聊天界面整洁。
