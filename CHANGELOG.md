...
## [v3.9.6] - 2026-01-11 (User Sovereignty Release)

### 🚀 New Features
- **🎛️ Data Analyst 11.0 (手动控制中心)**: 
  - **强制开启开关**: 在工具栏新增“数据分析”一级 Toggle，允许用户在自动识别失效或针对纯架构文档时强制唤醒分析引擎。
  - **JIT 架构推演**: 优化了在物理数据缺失时的激活逻辑，确保手动开启后 100% 呈现可视化看板。
  - **工具栏 UI 优化**: 重新分配列宽，完美适配深度思考、联网搜索、智能研究与数据分析四个并列开关。
