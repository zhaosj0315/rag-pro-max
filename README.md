...
![Version](https://img.shields.io/badge/version-v2.8.0-brightgreen)
...
**🎯 核心优势**: 联网实时增强 • 智能查询改写 • 极简 UI • 统一架构 • 零重复代码 • 企业级标准 • GPU加速 • 生产就绪
...
- **透明进度监控**: 实时展示联网搜索状态与命中结果，交互全程可感知
...
### 🛠️ 极简功能工具栏 (v2.8.0 新增)
- **一体化操作中心**: 位于输入框上方的紧凑工具栏，集成模型切换、快捷开关与会话管理
- **动态配置联动**: 厂商下拉框自动过滤未配置的服务商，模型列表实时同步保存至本地配置
- **零跳动输入框**: 统一 `st.chat_input` 布局逻辑，彻底消除生成回答时的布局闪烁
